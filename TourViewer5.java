...
public class TourViewer5
{

	/**
	 * Draws a 5x5 square board demonstrating a rook's tour
	 * 
	 * <p>
	...
	//Demonstrates a rook's tour on a 5x5 square board
	public static void main(String[] args) throws Exception
	{
		Location start = new Location(2,2);
		Piece rook = new Piece ("rook");
		Board currentBoard = new Board (5,5,start,rook);
