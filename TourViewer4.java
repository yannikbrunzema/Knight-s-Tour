...
{
	/**
	 * Draws a 10x10 board using an irregular knight
	 * 
	 * <p>
	...
	//Demonstrates an irregular knights tour on a 10x10 board
	public static void main(String[] args) throws Exception
	{
		Location start = new Location(1,1);
		Piece irregularKnight = new Piece ("irregular knight");
		Board currentBoard = new Board (10,10 ,start, irregularKnight);
